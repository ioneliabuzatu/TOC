...
if __name__ == "__main__":
    start_time = time()
    with open("../data/scenic/mouse/control/interaction_cID_trimmed_by_importance.txt.json") as file:
        data = file.read()
        genes_names_to_ids = json.loads(data)

    adjacencies = np.load("../data/scenic/mouse/control/GSE133382.adjacencies.trimmed.npy", allow_pickle=True)
